...
function getGiftCardRates() {
  return [
    { name: 'Amazon', logo: 'A', color: '#FF9900', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1400, sellRate: 1350 },
      'GBP': { flag: '\ud83c\uddec\ud83c\udde7', buyRate: 1550, sellRate: 1500 },
      'CAD': { flag: '\ud83c\udde8\ud83c\udde6', buyRate: 1280, sellRate: 1230 },
      'EUR': { flag: '\ud83c\uddea\ud83c\uddfa', buyRate: 1480, sellRate: 1430 },
      'AUD': { flag: '\ud83c\udde6\ud83c\uddfa', buyRate: 1150, sellRate: 1100 },
    }},
    { name: 'Apple/iTunes', logo: '\ud83c\udf4e', color: '#555555', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1410, sellRate: 1360 },
      'GBP': { flag: '\ud83c\uddec\ud83c\udde7', buyRate: 1560, sellRate: 1510 },
      'CAD': { flag: '\ud83c\udde8\ud83c\udde6', buyRate: 1290, sellRate: 1240 },
      'EUR': { flag: '\ud83c\uddea\ud83c\uddfa', buyRate: 1490, sellRate: 1440 },
      'AUD': { flag: '\ud83c\udde6\ud83c\uddfa', buyRate: 1160, sellRate: 1110 },
    }},
    { name: 'Steam', logo: 'S', color: '#171A21', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1320, sellRate: 1280 },
      'GBP': { flag: '\ud83c\uddec\ud83c\udde7', buyRate: 1470, sellRate: 1420 },
      'EUR': { flag: '\ud83c\uddea\ud83c\uddfa', buyRate: 1400, sellRate: 1360 },
      'AUD': { flag: '\ud83c\udde6\ud83c\uddfa', buyRate: 1090, sellRate: 1050 },
    }},
    { name: 'eBay', logo: 'e', color: '#E53238', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1300, sellRate: 1250 },
      'GBP': { flag: '\ud83c\uddec\ud83c\udde7', buyRate: 1450, sellRate: 1400 },
      'AUD': { flag: '\ud83c\udde6\ud83c\uddfa', buyRate: 1080, sellRate: 1030 },
    }},
    { name: 'Sephora', logo: 'S', color: '#000000', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1290, sellRate: 1240 },
      'CAD': { flag: '\ud83c\udde8\ud83c\udde6', buyRate: 1170, sellRate: 1120 },
    }},
    { name: 'Visa', logo: 'V', color: '#1A1F71', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1420, sellRate: 1370 },
      'GBP': { flag: '\ud83c\uddec\ud83c\udde7', buyRate: 1570, sellRate: 1520 },
      'CAD': { flag: '\ud83c\udde8\ud83c\udde6', buyRate: 1300, sellRate: 1250 },
      'EUR': { flag: '\ud83c\uddea\ud83c\uddfa', buyRate: 1500, sellRate: 1450 },
      'AUD': { flag: '\ud83c\udde6\ud83c\uddfa', buyRate: 1170, sellRate: 1120 },
    }},
    { name: 'Google Play', logo: '\u25b6', color: '#34A853', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1380, sellRate: 1320 },
      'GBP': { flag: '\ud83c\uddec\ud83c\udde7', buyRate: 1520, sellRate: 1470 },
      'CAD': { flag: '\ud83c\udde8\ud83c\udde6', buyRate: 1260, sellRate: 1210 },
      'EUR': { flag: '\ud83c\uddea\ud83c\uddfa', buyRate: 1460, sellRate: 1410 },
      'AUD': { flag: '\ud83c\udde6\ud83c\uddfa', buyRate: 1130, sellRate: 1080 },
    }},
    { name: 'Nike', logo: 'N', color: '#111111', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1260, sellRate: 1210 },
      'GBP': { flag: '\ud83c\uddec\ud83c\udde7', buyRate: 1410, sellRate: 1360 },
      'EUR': { flag: '\ud83c\uddea\ud83c\uddfa', buyRate: 1340, sellRate: 1290 },
    }},
    { name: 'Xbox', logo: 'X', color: '#107C10', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1340, sellRate: 1290 },
      'GBP': { flag: '\ud83c\uddec\ud83c\udde7', buyRate: 1490, sellRate: 1440 },
      'CAD': { flag: '\ud83c\udde8\ud83c\udde6', buyRate: 1220, sellRate: 1170 },
      'EUR': { flag: '\ud83c\uddea\ud83c\uddfa', buyRate: 1420, sellRate: 1370 },
      'AUD': { flag: '\ud83c\udde6\ud83c\uddfa', buyRate: 1100, sellRate: 1060 },
    }},
    { name: 'PlayStation', logo: 'P', color: '#003791', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1350, sellRate: 1300 },
      'GBP': { flag: '\ud83c\uddec\ud83c\udde7', buyRate: 1500, sellRate: 1450 },
      'EUR': { flag: '\ud83c\uddea\ud83c\uddfa', buyRate: 1430, sellRate: 1380 },
      'JPY': { flag: '\ud83c\uddef\ud83c\uddf5', buyRate: 1280, sellRate: 1230 },
      'AUD': { flag: '\ud83c\udde6\ud83c\uddfa', buyRate: 1110, sellRate: 1060 },
    }},
    { name: 'Netflix', logo: 'N', color: '#E50914', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1400, sellRate: 1350 },
      'GBP': { flag: '\ud83c\uddec\ud83c\udde7', buyRate: 1550, sellRate: 1500 },
      'EUR': { flag: '\ud83c\uddea\ud83c\uddfa', buyRate: 1480, sellRate: 1430 },
    }},
    { name: 'Spotify', logo: '\u266b', color: '#1DB954', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1370, sellRate: 1320 },
      'GBP': { flag: '\ud83c\uddec\ud83c\udde7', buyRate: 1520, sellRate: 1470 },
      'EUR': { flag: '\ud83c\uddea\ud83c\uddfa', buyRate: 1450, sellRate: 1400 },
      'AUD': { flag: '\ud83c\udde6\ud83c\uddfa', buyRate: 1120, sellRate: 1070 },
    }},
    { name: 'Nordstrom', logo: 'N', color: '#000000', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1310, sellRate: 1260 },
      'CAD': { flag: '\ud83c\udde8\ud83c\udde6', buyRate: 1190, sellRate: 1140 },
    }},
    { name: 'BestBuy', logo: 'B', color: '#0046BE', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1290, sellRate: 1240 },
      'CAD': { flag: '\ud83c\udde8\ud83c\udde6', buyRate: 1170, sellRate: 1120 },
    }},
    { name: 'Razer Gold', logo: 'R', color: '#44D62C', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1300, sellRate: 1250 },
      'EUR': { flag: '\ud83c\uddea\ud83c\uddfa', buyRate: 1380, sellRate: 1330 },
      'MYR': { flag: '\ud83c\uddf2\ud83c\uddfe', buyRate: 1200, sellRate: 1150 },
    }},
    { name: 'Roblox', logo: 'R', color: '#E2231A', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1280, sellRate: 1230 },
      'GBP': { flag: '\ud83c\uddec\ud83c\udde7', buyRate: 1430, sellRate: 1380 },
      'EUR': { flag: '\ud83c\uddea\ud83c\uddfa', buyRate: 1360, sellRate: 1310 },
    }},
    { name: 'Walmart', logo: 'W', color: '#0071CE', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1280, sellRate: 1230 },
      'CAD': { flag: '\ud83c\udde8\ud83c\udde6', buyRate: 1160, sellRate: 1110 },
    }},
    { name: 'Target', logo: 'T', color: '#CC0000', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1270, sellRate: 1220 },
    }},
    { name: "Macy's", logo: 'M', color: '#E21A2C', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1260, sellRate: 1210 },
    }},
    { name: 'Vanilla Visa', logo: 'VV', color: '#1A1F71', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1390, sellRate: 1340 },
      'CAD': { flag: '\ud83c\udde8\ud83c\udde6', buyRate: 1270, sellRate: 1220 },
    }},
    { name: 'GameStop', logo: 'G', color: '#333333', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1250, sellRate: 1200 },
      'CAD': { flag: '\ud83c\udde8\ud83c\udde6', buyRate: 1130, sellRate: 1080 },
    }},
    { name: 'CVS', logo: 'C', color: '#CC0000', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1240, sellRate: 1190 },
    }},
    { name: 'Footlocker', logo: 'F', color: '#333333', countries: {
      'USD': { flag: '\ud83c\uddfa\ud83c\uddf8', buyRate: 1270, sellRate: 1220 },
      'EUR': { flag: '\ud83c\uddea\ud83c\uddfa', buyRate: 1350, sellRate: 1300 },
    }},
  ];
}
...
function tradeGiftCard(cardType, cardValue, tradeType, rate) {
  ...
  // (country/rate validation handled in caller)
